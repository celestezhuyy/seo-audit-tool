...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v8.2 修复了重复内容检测逻辑，避免页面与自身对比误报。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v8.2",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v8.2",
        ...
        "input_info": "Note: v8.2 fixes duplicate content logic (prevents self-duplication).",
