...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v8.9 修复了 Web 预览变量错误，确保全流程稳定。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v8.9",
        ...
        "url_underscore": "URL 包含下划线", "url_underscore_desc": "URL 路径中使用下划线 (_) 分隔单词。", "url_underscore_impact": "Google treats underscores as joiners, not separators, hurting keyword parsing.", "url_underscore_sugg": "Use hyphens (-) instead of underscores.",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v8.8",
        ...
        "input_info": "Note: v8.8 features improved duplicate grouping and Robots.txt analysis.",
