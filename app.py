...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v14.1 (Baidu FCP)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v14.1 新增服务器地理位置检测，并针对百度 SEO 强调 FCP < 2秒。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v14.1",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v14.1",
        ...
        "input_info": "Note: v14.1 features ICP, Chinese Content check & Server Location.",
