...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v5.5 (Final)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v5.5 修复了变量名错误，确保全流程无 Bug。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v5.5",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v5.5",
        ...
        "input_info": "Note: v5.5 features fully corrected localization, enhanced descriptions, and smart schema recommendations.",
...
def get_translated_text(issue_id, lang, args=None):
    ...
    t = TRANSLATIONS[lang]
    # Check if we have specific keys for title/desc/impact/sugg
    # If issue_id is "lcp_issue", we look for "lcp_issue", "lcp_issue_desc", etc.
    # For older keys like "missing_title", they map directly.
    return {
