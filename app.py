...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v6.4 (Fix)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v6.4 修复了 Content_Hash 键名错误，确保数据一致性。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v6.4",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v6.4",
        ...
        "input_info": "Note: v6.4 features strict logic, full English/Chinese separation, and detailed recommendations.",
