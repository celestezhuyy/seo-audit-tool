...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v9.0 修复了重定向路径显示、长标题模拟及结构化数据建议文案。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v9.0",
        ...
        "missing_jsonld": "缺失结构化数据", "missing_jsonld_desc": "未检测到 Schema.org 标记。", "missing_jsonld_impact": "错失富媒体搜索结果（Rich Results），在 SERP 中不如竞争对手显眼。", "missing_jsonld_sugg": "建议添加结构化数据。根据页面特征，推荐添加类型：{}。",
