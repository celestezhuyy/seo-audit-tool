...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v5.2 彻底修复了中英文案混杂问题，并大幅丰富了建议内容。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v5.2",
        ...
        "cls_sugg": "为所有图片和视频元素指定明确的宽度和高度属性，避免在顶部动态插入内容。",
        ...
        "cls_risk_sugg": "在 HTML 中显式指定图片和视频的宽度和高度属性。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v5.2",
        ...
        "input_info": "Note: v5.2 features fully corrected localization, enhanced descriptions, and smart schema recommendations.",
        ...
        "lcp_impact": "LCP is a core ranking factor. Slow loading speeds significantly increase bounce rates and lower search rankings.", 
...
def analyze_page(url, html_content, status_code, lang="zh", sitemap_has_hreflang=False):
    ...
    if not soup.find('script', type='application/ld+json'):
         ...
         custom_sugg = t['missing_jsonld_sugg'].format(spec_rec) 
