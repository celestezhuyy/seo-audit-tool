...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v13.0 (Refactored)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v13.0 重构了代码结构，彻底解决缩进报错问题。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v13.0",
        ...
        "input_info": "Note: v13.0 features refactored structure for stability.",
