...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v6.7 (Stable)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v6.7 彻底优化了代码结构，防止函数丢失错误。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v6.7",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v6.7",
        ...
        "input_info": "Note: v6.7 features fully corrected localization, enhanced descriptions, and smart schema recommendations.",
        ...
        "missing_jsonld_impact": "Missed opportunity for Rich Snippets (e.g., Stars, Price, etc.) which boost CTR.", 
...
# 初始化关键变量 (防NameError)
target_url = "" # Global init
max_pages = 100
manual_robots = ""
manual_sitemaps = []
psi_key = ""
start_btn = False # Global init
