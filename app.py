...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v4.7 修复了 PPT 生成时的 NameError，确保所有问题按逻辑顺序排列。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v4.7",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v4.7",
        ...
        "input_info": "Note: v4.7 fixes NameError in PPT generation and ensures logical issue ordering.",
