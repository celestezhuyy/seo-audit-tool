...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v6.1 (Stable)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v6.1 包含全链路变量保护，确保运行稳定。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v6.1",
    ...
    if st.button(ui["start_btn"], type="primary"):
        if not target_url or not is_valid_url(target_url): 
            ...
            with st.spinner(ui["spinner_crawl"].format(max_p)):
                data, issues, error_msg = crawl_website(target_url, max_p, lang, manual_robots, manual_sitemaps, psi_key)
                if not data:
