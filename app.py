...
ISSUE_PRIORITY_LIST = [
    ...
    "missing_baidu_stats", "missing_baidu_verify", "missing_applicable_device", "missing_no_transform", # Baidu Tech
    # 4. Content
...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v12.0 (Baidu Pro)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v12.0 增加了百度移动适配(applicable-device)和转码控制(no-transform)检测。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v12.0",
        ...
        "short_desc": "元描述过短", "short_desc_desc": "描述内容过少 (约 {} px)，吸引力不足。", "short_desc_impact": "无法充分展示页面卖点，在搜索结果中缺乏竞争力。", "short_desc_sugg": "扩充描述至 400-920 px，提供更多有价值的信息。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v11.1",
        ...
        "input_info": "Note: v11.1 adds Baidu SEO Mode with Keywords and Tongji checks.",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v11.0",
