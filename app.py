...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v8.0 提供了谷歌风格的 CWV 可视化图表及更准确的 3xx/Alt 问题展示。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v8.0",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v8.0",
        ...
        "input_info": "Note: v8.0 features Google-style CWV charts and accurate visualizations.",
...
def draw_cwv_gauge(slide, metric, value, thresholds):
    ...
    # Marker Logic
    # Map value to position (Linear mapping within ranges is complex, simplified to 3 zones)
    # Zone 1: 0 to good -> 0 to w/3
    # Zone 2: good to poor -> w/3 to 2w/3
    # Zone 3: > poor -> 2w/3 to w
...
def create_styled_pptx(slides_data, lang):
    ...
    def draw_serp_preview(slide, issue_title, evidence, url):
        ...
        if "favicon" in issue_title.lower():
             ...
             callout.text_frame.text = "Voice: \"filename_123.jpg\""
             callout.text_frame.paragraphs[0].font.color.rgb = RGBColor(50, 50, 50)
    ...
    if not st.session_state['audit_issues']: st.warning(ui["warn_no_data"])
        ...
        with st.container(border=True):
            ...
            with c2:
                ...
                is_cwv = any(k in s['id'] for k in ["lcp", "inp", "cls"])
                is_img = "alt" in s['id']
