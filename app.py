...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v10.0 (Pixel-Perfect)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v10.0 采用基于像素的长度检测标准，并优化了所有可视化细节。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v10.0",
...
def draw_cwv_gauge(slide, metric, value, thresholds):
    ...
    def add_label(x_offset, text):
        # Move up to touch bottom of bar
