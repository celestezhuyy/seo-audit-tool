...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v6.9 (Stable)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v6.9 修复了 PPT 生成时的 AttributeError，确保字体样式正确应用。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v6.9",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v6.9",
        ...
        "input_info": "Note: v6.9 features fixed PPT generation and enhanced descriptions.",
