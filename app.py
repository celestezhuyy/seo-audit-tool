...
# --- 2. 排序逻辑配置 (Strict Logic Flow - UPDATED) ---
# 逻辑顺序修正：可访问性 -> 索引 -> 技术 -> 内容 -> 体验与性能 (CWV 压轴)
CATEGORY_ORDER = ["access", "indexability", "technical", "content", "cwv_performance", "image_ux"]
SEVERITY_ORDER = {"Critical": 0, "High": 1, "Medium": 2, "Low": 3}

# 这是 PPT 和列表的“剧本”，决定了问题出现的先后顺序
ISSUE_PRIORITY_LIST = [
    # --- 第1章: 可访问性与基础 (Foundation) ---
    "no_robots", "robots_bad_rule", "robots_no_sitemap", # 门卫
    "no_sitemap", "sitemap_invalid", # 地图
    "http_5xx", "http_4xx", "soft_404", "http_3xx", # 道路状况
    
    # --- 第2章: 索引与规范 (Identity) ---
    "duplicate_content", # 身份重叠 (最重要)
    "missing_canonical", # 身份证明缺失
    "hreflang_invalid", "hreflang_no_default", "missing_hreflang", # 国际身份
    
    # --- 第3章: 技术架构 (Architecture) ---
    "missing_viewport", # 移动端适配
    "missing_jsonld", # 结构化数据
    "js_links", # 链接可爬性
    "url_underscore", "url_uppercase", # URL 规范
    
    # --- 第4章: 页面内容 (On-Page) ---
    "missing_title", "short_title", "long_title", # Title
    "missing_desc", "short_desc", # Meta Desc
    "missing_h1", # H1
    
    # --- 第5章: 体验与性能 (Experience & Performance) ---
    # 核心 Web 指标 (CWV) - 必须连续讲！
    "lcp_issue", # 加载速度 (Loading)
    "inp_issue", # 交互响应 (Interactivity)
    "cls_issue", # 视觉稳定 (Stability)
    "cls_risk",  # 静态代码导致的稳定性风险 (图片无宽高)
...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v4.5 修正了报告逻辑顺序 (Access -> Tech -> Content -> CWV)，CWV 指标作为压轴展示。",
        "input_label": "输入目标网址",
        ...
        # Categories Labels
        "cat_cwv_performance": "核心性能 (Core Web Vitals)",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v4.5",
        ...
        "cls_issue": "CLS (累积布局偏移) 超标", "cls_desc": "CLS 为 {:.3f} (目标 <0.1)。视觉不稳定。", "cls_impact": "核心排名因素。用户体验差。", "cls_sugg": "指定图片宽高。",
        "inp_issue": "INP (交互延迟) 超标", "inp_desc": "INP 为 {}ms (目标 <200ms)。响应迟钝。", "inp_impact": "核心排名因素。影响转化。", "inp_sugg": "优化 JS 执行。",
        "no_robots": "缺失 Robots.txt", "no_robots_desc": "无法访问 robots.txt。", "no_robots_impact": "爬取不可控。", "no_robots_sugg": "创建文件。",
        "robots_bad_rule": "Robots.txt 封禁风险", "robots_desc": "检测到全站封禁规则。", "robots_impact": "导致不收录。",
        "robots_no_sitemap": "Robots 未声明 Sitemap", "robots_no_sitemap_desc": "未指明 Sitemap 位置。", "robots_no_sitemap_impact": "发现页面变慢。",
        "no_sitemap": "Sitemap 访问失败", "no_sitemap_desc": "无法访问 Sitemap。", "no_sitemap_impact": "深层页面难发现。",
        ...
        "5xx_title": "服务器错误 (5xx)", "5xx_desc": "服务器报错。", "5xx_impact": "严重影响收录。", "5xx_sugg": "检查服务器。",
        "hreflang_invalid": "Hreflang 格式错误", "hreflang_invalid_desc": "代码不符合 ISO 标准。", "hreflang_invalid_impact": "国际化失效。",
        "hreflang_no_default": "Hreflang 缺失 x-default", "hreflang_no_default_desc": "无默认回退。", "hreflang_no_default_impact": "语言匹配错误。",
        "alt_bad_quality": "图片 Alt 质量差", "alt_bad_quality_desc": "使用无意义词汇。", "alt_bad_quality_impact": "错失图片流量。",
        "anchor_bad_quality": "锚文本质量差", "anchor_bad_quality_desc": "使用通用词汇。", "anchor_bad_quality_impact": "无法传递相关性。",
        "cls_risk": "CLS 布局偏移风险 (静态)", "cls_risk_desc": "Img 缺失宽高属性。", "cls_risk_impact": "导致页面抖动。",
        ...
        "long_title": "标题过长", "long_title_desc": "标题 >60 字符。", "long_title_impact": "SERP 截断。", "long_title_sugg": "精简标题。",
        ...
        "missing_viewport": "缺失 Viewport", "missing_viewport_desc": "无移动端配置。", "missing_viewport_impact": "移动端排名下降。", "missing_viewport_sugg": "添加 Viewport。",
        "missing_canonical": "缺失 Canonical", "missing_canonical_desc": "无规范标签。", "missing_canonical_impact": "重复内容风险。", "missing_canonical_sugg": "添加 Canonical。",
        "missing_jsonld": "缺失结构化数据", "missing_jsonld_desc": "无 Schema。", "missing_jsonld_impact": "无富媒体结果。", "missing_jsonld_sugg": "添加 Schema。",
        "missing_hreflang": "缺失 Hreflang", "missing_hreflang_desc": "无语言标记。", "missing_hreflang_impact": "国际化差。", "missing_hreflang_sugg": "添加 Hreflang。",
        "soft_404": "软 404", "soft_404_desc": "假 200 页面。", "soft_404_impact": "浪费预算。", "soft_404_sugg": "配置 404。",
        "missing_alt": "缺失 Alt", "missing_alt_desc": "图片无 Alt。", "missing_alt_impact": "不利图片 SEO。", "missing_alt_sugg": "添加 Alt。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v4.5",
        ...
        "input_info": "Note: v4.5 features strict logical ordering (Access -> Tech -> Content -> CWV).",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v4.4",
        ...
        # Issues
        "lcp_issue": "LCP Fails", "lcp_desc": "LCP is {:.2f}s (Target <2.5s).", "lcp_impact": "Ranking Factor. Bad UX.", "lcp_sugg": "Optimize images/JS.",
        "cls_issue": "CLS Fails", "cls_desc": "CLS is {:.3f} (Target <0.1).", "cls_impact": "Ranking Factor. Layout shifts.", "cls_sugg": "Set dimensions.",
        "inp_issue": "INP Fails", "inp_desc": "INP is {}ms (Target <200ms).", "inp_impact": "Ranking Factor. Unresponsive.", "inp_sugg": "Optimize JS.",
        "no_robots": "Missing Robots.txt", "no_robots_desc": "Not found.", "no_robots_impact": "Crawling issues.", "no_robots_sugg": "Create robots.txt.",
        "robots_bad_rule": "Robots Blocking", "robots_desc": "Blocking all.", "robots_impact": "De-indexing.",
        "robots_no_sitemap": "Sitemap Missing in Robots", "robots_no_sitemap_desc": "No link.", "robots_no_sitemap_impact": "Slow discovery.",
        "no_sitemap": "Sitemap Failed", "no_sitemap_desc": "Access denied.", "no_sitemap_impact": "Poor indexing.",
        "sitemap_invalid": "Invalid Sitemap", "sitemap_invalid_desc": "XML Error.", "sitemap_invalid_impact": "Unreadable.",
        "no_favicon": "Missing Favicon", "no_favicon_desc": "No icon.", "no_favicon_impact": "Lower CTR.", "no_favicon_sugg": "Add favicon.",
        "duplicate": "Duplicate Content", "duplicate_desc": "Duplicate without canonical.", "duplicate_impact": "Keyword cannibalization.", "duplicate_sugg": "Use canonicals.",
        "3xx_title": "Redirect Chain", "3xx_desc": "Internal redirect.", "3xx_impact": "Wasted budget.", "3xx_sugg": "Update links.",
        "4xx_title": "Broken Link", "4xx_desc": "4xx Error.", "4xx_impact": "Bad UX.", "4xx_sugg": "Fix links.",
        "5xx_title": "Server Error", "5xx_desc": "5xx Error.", "5xx_impact": "Crawl reduction.", "5xx_sugg": "Check server.",
        "hreflang_invalid": "Invalid Hreflang", "hreflang_invalid_desc": "Bad code.", "hreflang_invalid_impact": "Targeting fails.",
        "hreflang_no_default": "No x-default", "hreflang_no_default_desc": "No fallback.", "hreflang_no_default_impact": "Wrong lang.",
        "alt_bad_quality": "Bad Alt Text", "alt_bad_quality_desc": "Generic text.", "alt_bad_quality_impact": "No image SEO.",
        "anchor_bad_quality": "Bad Anchor", "anchor_bad_quality_desc": "Generic anchor.", "anchor_bad_quality_impact": "No context.",
        "cls_risk": "CLS Risk (Static)", "cls_risk_desc": "Missing dims.", "cls_risk_impact": "Layout shifts.",
        "missing_title": "Missing Title", "missing_title_desc": "No title.", "missing_title_impact": "Ranking loss.", "missing_title_sugg": "Add title.",
        ...
        "missing_desc": "Missing Desc", "missing_desc_desc": "No meta desc.", "missing_desc_impact": "Lower CTR.", "missing_desc_sugg": "Add desc.",
        "short_desc": "Desc Short", "short_desc_desc": "Too thin.", "short_desc_impact": "Low appeal.", "short_desc_sugg": "Expand desc.",
        ...
        "missing_jsonld": "No Schema", "missing_jsonld_desc": "No JSON-LD.", "missing_jsonld_impact": "No rich results.", "missing_jsonld_sugg": "Add Schema.",
        ...
        "missing_alt": "Missing Alt", "missing_alt_desc": "No alt.", "missing_alt_impact": "Bad image SEO.", "missing_alt_sugg": "Add alt.",
...
def analyze_page(url, html_content, status_code, lang="zh", sitemap_has_hreflang=False):
    ...
    # 将 Static CLS Risk 归类为 cwv_performance，以确保它紧跟在 CLS 之后
    if cls_risk_count > 0:
                    ...
                    if current_hash in seen_hashes:
                        ...
                        if len(current_url) < len(original_url) and '?' not in current_url and '?' in original_url:
                            ...
                            if not is_handled:
                                # 重复内容特殊标记
                                dup_issue = {
                                    "id": "duplicate_content", "category": "indexability", 
...
def create_styled_pptx(slides_data, lang="zh"):
    ...
    for issue in slides_data:
        ...
        # Cleaning URL for display if it has duplicate metadata appended
