...
TRANSLATIONS = {
    "zh": {
        ...
        "psi_api_help": "留空则仅进行静态代码检查。填入 Key 可获取首页的真实用户体验数据 (LCP, CLS, INP) 并将其纳入审计报告。",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v3.9 集成了 Core Web Vitals (CWV) 的深度评估，性能问题将直接生成报告。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v3.9",
        ...
        "cls_risk": "存在 CLS 布局偏移风险 (CWV - Static)",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v3.9",
        # ... (EN translations similar structure, adding CWV keys)
        "cat_cwv_performance": "0. Core Web Vitals (Performance)",
