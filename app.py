...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v6.10 (Final)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v6.10 优化了分类展示，移除了不必要的编号。",
        "input_label": "输入目标网址",
        ...
        # Categories Labels - Removed Numbers
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v6.10",
        ...
        "http_4xx": "死链/客户端错误 (4xx)", "http_4xx_desc": "内部链接返回 404 (未找到) 或 403 (禁止访问) 错误。", "http_4xx_impact": "严重破坏用户体验，中断权重传递路径，并可能导致已索引的页面被 Google 移除。", "http_4xx_sugg": "配置服务器对不存在的页面返回 404 HTTP 状态码。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v6.10",
        ...
        "input_info": "Note: v6.10 features strict logic, full English/Chinese separation, and detailed recommendations.",
