...
manual_sitemaps = []
psi_key = ""
psi_list_url = ""   # v7.1 Restored
psi_detail_url = "" # v7.1 Restored
start_btn = False
...
TRANSLATIONS = {
    "zh": {
        ...
        "psi_list_url_label": "产品列表页 URL (可选)", # v7.1 Restored
        "psi_detail_url_label": "产品详情页 URL (可选)", # v7.1 Restored
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v7.2 整合了多页面 CWV 检测与所有已知 Bug 修复。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v7.2",
    ...
    "en": {
        ...
        "input_info": "Note: v7.0 features strict logic, full English/Chinese separation, and detailed recommendations.",
