...
TRANSLATIONS = {
    ...
    "en": {
        ...
        # ... (EN translations kept same structure, simplified here for brevity, logic applies same as ZH)
        # Adding placeholder keys to prevent KeyError in EN mode
