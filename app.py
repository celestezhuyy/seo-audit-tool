...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v5.9 实现完全的数据与展示分离，支持任意时刻无缝切换语言报告。",
        "input_label": "输入目标网址",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v5.9",
        ...
        "input_info": "Note: v5.9 features full dynamic language switching. You can switch report language anytime.",
        ...
        "3xx_title": "Redirect Chain", "3xx_desc": "Internal link triggers a 301 or 302 redirect.", "3xx_impact": "Wastes crawl budget, adds latency to page load, and dilutes the link equity passed to the destination.", "3xx_sugg": "Update the internal link to point directly to the final destination URL.",
        "4xx_title": "Broken Link", "4xx_desc": "Internal link returns a 4xx error (e.g., 404 Not Found).", "4xx_impact": "Creates a bad user experience, breaks the flow of link equity, and may cause indexed pages to be dropped.", "4xx_sugg": "Fix the broken link or remove it.",
        "5xx_title": "Server Error", "5xx_desc": "Server returned a 5xx error (e.g., 500 Internal Server Error).", "5xx_impact": "Signals server instability. Googlebot will reduce the crawl rate of your site to avoid overloading it.", "5xx_sugg": "Check server error logs and ensure database stability.",
...
def create_styled_pptx(slides_data, lang):
    ...
    for s in slides_data:
        ...
        p.text = t_data['title'] # Ensure title is translated
        ...
        p.text = txt["ppt_desc"]
        set_font(p, 18, True, RGBColor(30, 30, 30))
