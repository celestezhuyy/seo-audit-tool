...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v6.2 (Fix)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v6.2 修复了函数丢失导致的 NameError，确保核心验证逻辑正常运行。",
        "input_label": "输入目标网址",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v6.2",
        ...
        "input_info": "Note: v6.2 features strict logic, full English/Chinese separation, and detailed recommendations.",
