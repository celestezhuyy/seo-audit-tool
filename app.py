...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v8.4 修复了预览模式变量错误。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v8.4",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v8.4",
        ...
        "input_info": "Note: v8.4 features fixed web preview variable name error.",
