...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v7.8 优化了 Hreflang 代码示例、Favicon 和 CWV 的可视化效果。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v7.8",
        ...
        "visual_sim_title": "视觉体验模拟 (Visual Simulation):",
        "cwv_sim_title": "核心指标可视化 (CWV):",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v7.8",
        ...
        "input_info": "Note: v7.8 features enhanced visuals for Favicon, Hreflang & CWV.",
        ...
        "3xx_desc": "Internal link triggers a redirect (Chain: {}).", 
...
def create_styled_pptx(slides_data, lang):
    ...
    def draw_hreflang_preview(slide):
        # Draw Code Box for Hreflang
        box = slide.shapes.add_shape(MSO_SHAPE.RECTANGLE, Inches(7), Inches(4), Inches(5.8), Inches(2.5))
        box.fill.solid()
        box.fill.fore_color.rgb = RGBColor(245, 245, 245)
        box.line.color.rgb = RGBColor(200, 200, 200)
        ...
        p = tf.add_paragraph()
        p.text = '<link rel="alternate" hreflang="en-US" href="..." />'
        set_font(p.font, 11, False, RGBColor(0, 0, 128))
        
        p = tf.add_paragraph()
        p.text = '<link rel="alternate" hreflang="x-default" href="..." />'
        set_font(p.font, 11, True, RGBColor(200, 0, 0))
    ...
    for s in slides_data:
        ...
        if is_code:
            ...
            draw_hreflang_preview(slide)
        elif is_rich:
            draw_rich_snippet_preview(slide, ex_url)
        elif is_serp or is_img or is_cwv or is_3xx:
