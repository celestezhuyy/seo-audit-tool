...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v8.1 修复了重定向可视化显示问题，优化 Alt 展示。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v8.1",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v8.1",
        ...
        "input_info": "Note: v8.1 features enhanced 3xx visualization and layout fixes.",
