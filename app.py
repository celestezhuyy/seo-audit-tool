...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v4.0 包含重复内容溯源展示、混合布局 PPT 及无编号分类逻辑。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v4.0",
        "ppt_slide_desc_title": "深度分析",
        "ppt_slide_count_title": "样本中受影响页面数: {} 个",
        "ppt_slide_ex_title": "受影响页面示例", # Updated
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v4.0",
        ...
        "input_info": "Note: v4.0 includes Duplicate Content tracing, Split-layout PPT & Cleaned Categories.",
        ...
        "ppt_slide_ex_title": "Affected Page Examples", # Updated
...
def check_cwv_issues(cwv_data, url, lang="zh"):
    ...
    if lcp > 2.5:
        ...
        issues.append({
            ...
            "url": url,
            "examples": [url] # Ensure example exists
        })
...
def create_styled_pptx(slides_data, lang="zh"):
    ...
    for issue in slides_data:
        ...
        if "Duplicate" in issue['title'] or "重复" in issue['title']:
            # For duplicate content, we need special formatting
            # Check if example is a string or list (it should be a list of strings)
            # The string itself contains the "Duplicate of" text from crawl logic
            pass
