...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v5.6 (Final Fix)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v5.6 修复了变量名错误，确保全流程无 Bug。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v5.6",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v5.6",
        ...
        "input_info": "Note: v5.6 fixes variable naming error for seamless execution.",
...
if menu_key == "input":
    ...
    with col1:
        # Fixed: Renamed url_input to target_url to match downstream logic
    ...
    # Fixed: Use target_url consistently
    if start_btn and target_url:
        if not is_valid_url(target_url): st.error(ui["error_url"])
            ...
            with st.spinner(ui["spinner_crawl"].format(max_pages)):
                # Fixed: Use target_url here as well
    ...
    if not st.session_state['audit_data']: st.warning(ui["warn_no_data"])
        ...
        with c1:
            ...
            # Use Translated Titles for Chart
            if issues:
