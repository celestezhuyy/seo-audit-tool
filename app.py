...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v4.6 修复了建议丢失问题，清理了冗余代码，确保结构化数据建议准确。",
        "input_label": "输入目标网址",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v4.6",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v4.6",
        ...
        "input_info": "Note: v4.6 includes updated Smart Schema suggestions.",
