...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v14.3 新增 Sitemap 内容粘贴功能，便于测试未发布的站点地图。",
        ...
        "sitemap_content_label": "粘贴 Sitemap XML 内容 (直接解析)", # New
        "start_btn": "开始深度爬取",
        "error_url": "网址格式错误",
    ...
    "en": {
        ...
        "manual_pages_label": "Manual Pages to Audit (One per line)", # New
        "sitemap_content_label": "Paste Sitemap XML Content (Direct Parse)", # New
