...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v7.7 修复了 PPT 生成时的颜色填充错误。",
        ...
        "ppt_cover_sub": "Generated by AuditAI Pro v7.7",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v7.7",
        ...
        "input_info": "Note: v7.7 features smart domain locking for better crawling.",
...
def create_styled_pptx(slides_data, lang):
    ...
    def draw_serp_preview(slide, issue_title, evidence, url):
        ...
        box.fill.solid() # Fix: Set solid fill
        ...
        if "favicon" in issue_title.lower():
             ...
             bar.fill.solid() # Fix
             bar.fill.fore_color.rgb = RGBColor(220, 53, 69) 
