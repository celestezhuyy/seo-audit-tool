...
ISSUE_PRIORITY_LIST = [
    ...
    "missing_icp", "content_not_chinese", "missing_baidu_stats", "missing_baidu_verify", "missing_applicable_device", "missing_no_transform",
...
TRANSLATIONS = {
    "zh": {
        ...
        "sidebar_caption": "旗舰审计版 v14.0 (ICP & Lang)",
        "nav_label": "功能导航",
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v14.0 增加了 ICP 备案检测和页面中文内容占比分析。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v14.0",
        ...
        "input_info": "Note: v14.0 features ICP & Chinese Content check.",
