...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: v4.4 优化了 CWV 叙事顺序 (LCP->INP->CLS) 并修复了重复内容可视化。",
        "input_label": "输入目标网址",
        ...
        # Issues
        "lcp_issue": "LCP (最大内容绘制) 超标", "lcp_desc": "LCP 为 {:.2f}s (目标 <2.5s)。加载过慢。", "lcp_impact": "核心排名因素。高跳出率。", "lcp_sugg": "优化图片/CDN。",
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v4.4",
        ...
        "input_info": "Note: v4.4 features strict logical ordering (CWV -> Access -> Tech -> Content).",
