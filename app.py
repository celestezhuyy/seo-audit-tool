...
TRANSLATIONS = {
    "zh": {
        ...
        "input_header": "开始深度审计",
        "input_info": "说明: 增强反爬虫绕过能力，修复了重定向导致的爬取中断问题。",
        "input_label": "输入目标网址",
    ...
    "en": {
        ...
        "input_info": "Note: Improved WAF bypass & Fixed redirect loop issues.",
        ...
        try:
            ...
            if 'text/html' in content_type:
                ...
                if current_hash in seen_hashes:
                    ...
                    is_ok = current_canonical and current_canonical != current_url
                    if not is_ok:
                        page_issues.append({
                            "severity": "High", "title": t_dup_title, "desc": f"{t_dup_desc} (vs {original_url})", 
                            "suggestion": t_dup_sugg, "url": current_url, "meta": f"Duplicate of: {original_url}"
                        })
                else:
