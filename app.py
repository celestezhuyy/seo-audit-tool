...
TRANSLATIONS = {
    "zh": {
        ...
        # Categories
        "cat_cwv_performance": "0. 核心性能指标 (Core Web Vitals)",
        ...
        "missing_hreflang_sugg": "如为多语言站点请在 HTML 头部或 Sitemap 中添加 hreflang。", # Fixed: Added missing key
    ...
    "en": {
        "sidebar_title": "🔍 AuditAI Pro",
        "sidebar_caption": "Deep Audit Edition v3.8.3",
        ...
        "missing_hreflang": "No Hreflang", "missing_hreflang_desc": "Missing tags.", "missing_hreflang_impact": "Poor internationalization.", "missing_hreflang_sugg": "Add hreflang tags.", # Fixed: Added missing key
